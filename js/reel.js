 ...
 $(document).ready(function() {
   ...
   var RPhover_tl = new TimelineMax({
     paused: true
   });
   ...
   .set('#Circle-Outline', {
     ...
     .to('#Circle-Outline', 0.9, {
       opacity: 0.1,
       strokeDasharray: '133 133',
       strokeDashoffset: 266,
       ease: Power2.easeOut
     }, "label--0X+=0.0")

   .from($("#Play-Pause").find('i'), 0.3, {
       scale: 0.25,
       opacity: 0.15,
       ease: Power3.easeInOut
     }, "label--0B+=0.12")
   ...
   Play_SVG.click(function() {
     ...
     if ($(this).hasClass('active')) {
       ...
       TweenMax.to('iframe', 0.6, {
         delay: 0.6,
         autoAlpha: 1,
         ease: Power1.easeIn
       });
       //container shadow
       TweenMax.to(RP_cont, 1.25, {
         width: 640,
         height: 360,
         boxShadow: '0.5em 1em 1em 0em rgba(0,2,6,0.08), 1em 2em 4em 0em rgba(0,2,6,0.08), 0em 0em 0em 0em rgba(0,2,6,0.06), 0em 0em 0em -4em rgba(0,2,6,0.12), 0em 0em 2em -4em rgba(0,2,6,0.12)',
       ...
       TweenMax.to(rp_BTM, 0.5, {
         backgroundColor: 'rgba(253, 254, 255, 0.95)',
         ease: Power2.easeInOut
       });
       TweenMax.to(video_BG, 1.0, {
         delay: 0.1,
         height: '100%',
         opacity: 1,
         ease: Expo.easeInOut
       });
       TweenMax.to(rp_img, 1.10, {
         delay: 0.0,
         scale: 0.5,
         opacity: 0.0,
         ease: Expo.easeInOut
       ...
       TweenMax.set(rp_h1, {
         transformOrigin: '20% 90em'
       });
       TweenMax.set(rp_h2, {
         transformOrigin: '20% 70em'
       });
       TweenMax.to(h1_h2, 1.10, {
         delay: 0.0,
         scale: 0.75,
         opacity: 0.0,
         ease: Expo.easeInOut,
       ...
       TweenMax.to(RP_cont, 1.5, {
         width: 360,
         height: 360,
         boxShadow: '0em 14em 21em 0em rgba(0,2,6,0.05), 0em 40em 15em -23em rgba(0,2,6,0.08), 0em 55em 30em -23em rgba(0,2,6,0.12), 0em 60em 55em -23em rgba(0,2,6,0.10), 0 50em 120em -23em rgba(0,2,6,0.24)',
         ease: Expo.easeOut
       });
